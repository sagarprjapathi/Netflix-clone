        ...
        <nav className="w-full fixed z-40">
            <div className={`px-4 md:px-16 py-6 flex flex-row items-center transition duration-500 ${showBackground ? 'bg-zinc-900 bg-opacity-90' : ''}`}>
               ...
               <div className="flex flex-row ml-auto gap-7 item-center">
                <div className="text-gray-200 hover:text-gray-300 cursor-pointer transiston">
                    <BsSearch />
                </div>
                <div className="text-gray-200 hover:text-gray-300 cursor-pointer transiston">
                    <BsBell />
                ...
                <div onClick={toggleAccountMenu} className="flex flex-row items gap-2 cursor-pointer relative">
                    <div className="w-6 h-6 lg:w-10 rounded-md overflow-hidden">
                        <img src="/images/default-blue.png" alt=""/>
                    </div>
                    <BsChevronDown className={`text-white fill-white transition ${showAccountMenu ? 'rotate-180' : 'rotate-0'}`} />
